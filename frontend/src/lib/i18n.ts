  ...
  es: {
    ...
    home: {
      ...
      cards: [
        ...
        { title: "Escaparates NYC", subtitle: "Tiendas icónicas, lujo, sneakers, deporte y mapa para descubrir qué te queda mejor.", label: "Style" },
  ...
  en: {
    ...
    home: {
      ...
      cards: [
        ...
        { title: "City Finds", subtitle: "Iconic stores, luxury, sneakers, sportswear, and a map to discover what fits you best.", label: "Style" },
